...
.t3:
    istruc rose
        at rose.x0, dd 32                    ; 左上座標X
        at rose.y0, dd 32                    ; 左上座標Y
        at rose.x1, dd 208                   ; 右下座標X
        at rose.y1, dd 208                   ; 右下座標Y
...
.t4:
    istruc rose
        at rose.x0, dd 248                    ; 左上座標X
        at rose.y0, dd 32                    ; 左上座標Y
        at rose.x1, dd 424                   ; 右下座標X
        at rose.y1, dd 208                   ; 右下座標Y
        ...
        at rose.color_y, dd 0x0007           ; Y軸の色
        at rose.color_z, dd 0x000F           ; 枠の色
        at rose.color_s, dd 0x040F           ; 文字の色
        at rose.color_f, dd 0x000F           ; グラフ描画色
        at rose.color_b, dd 0x0004           ; グラフ消去色
...
.t5:
    istruc rose
        at rose.x0, dd 32                    ; 左上座標X
        at rose.y0, dd 272                    ; 左上座標Y
        at rose.x1, dd 208                   ; 右下座標X
        at rose.y1, dd 448                   ; 右下座標Y
        ...
        at rose.color_y, dd 0x0007           ; Y軸の色
        at rose.color_z, dd 0x000F           ; 枠の色
        at rose.color_s, dd 0x050F           ; 文字の色
        at rose.color_f, dd 0x000F           ; グラフ描画色
        at rose.color_b, dd 0x0005           ; グラフ消去色
...
.t6:
    istruc rose
        ...
        at rose.color_y, dd 0x0007           ; Y軸の色
        at rose.color_z, dd 0x000F           ; 枠の色
        at rose.color_s, dd 0x060F           ; 文字の色
        at rose.color_f, dd 0x000F           ; グラフ描画色
        at rose.color_b, dd 0x0006           ; グラフ消去色
